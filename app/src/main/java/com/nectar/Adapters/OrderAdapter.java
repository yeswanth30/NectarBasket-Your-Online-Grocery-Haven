...
public class OrderAdapter extends RecyclerView.Adapter<OrderAdapter.ViewHolder> {
    ...
    public OrderAdapter(Context context, List<OrderItem1> orderItemList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        OrderItem1 orderItem = orderItemList.get(position);

        holder.productNameTextView.setText(orderItem.getItemName());
        holder.priceTextView.setText(orderItem.getProductAmount());
        holder.deliveryDateTextView.setText(orderItem.getDeliveryDate());

        holder.orderlayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                int clickedItemId = (orderItem.getProductid());
                int categorykiid = orderItem.getCategory_id();
              ...
              //  Toast.makeText(view.getContext(), "Clicked item Id: " + clickedItemId + "Category Id is: " + categorykiid, Toast.LENGTH_LONG).show();
                ...
                bundle.putInt("id", orderItem.getProductid());
                bundle.putInt("category_id", orderItem.getCategory_id());
        ...
        Picasso.get()
                .load("http://13.232.168.157/images/uploads/" + orderItem.getImage())
                .into(holder.productphoto12);

        holder.trackOrderButton.setOnClickListener(view -> {
            trackOrderApiCall(orderItem.getOrderid());
        });

        holder.generatePdfButton.setOnClickListener(view -> {
            onGeneratePdf(orderItem.getId());
        });
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ImageView productphoto12;
        TextView productNameTextView, priceTextView, deliveryDateTextView;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            productNameTextView.setOnClickListener(view -> {
        ...
        call.enqueue(new Callback<TrackOrderModel>() {
            ...
            public void onResponse(Call<TrackOrderModel> call, Response<TrackOrderModel> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if ("success".equals(trackOrderModel.getStatus()) && trackOrderModel.getData() != null) {
                    ...
                    Log.e("OrderAdapter", "Failed to track order. Response code: " + response.code());
                    Toast.makeText(context, "Failed to track order", Toast.LENGTH_SHORT).show();
                }
            }
